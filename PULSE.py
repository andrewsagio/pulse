...
class PULSE(torch.nn.Module):
    def __init__(self, cache_dir, verbose=True):
        ...
        with open_url("https://drive.google.com/uc?id=15fTHGsxvpkQgU7E9a6Da9-eLc6xMT2CZ", cache_dir=cache_dir, verbose=verbose) as f:
        ...
        if Path("gaussian_fit.pt").exists():
            ...
            with open_url("https://drive.google.com/uc?id=1rxU-mLpNfZOvHjelHdcGeSbW2Nd9r7WF", cache_dir=cache_dir, verbose=verbose) as f:
